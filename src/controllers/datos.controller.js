...
const incidencias_resueltas = async (req, res) => {
...
const area_mas_incidencia = async (req, res) => {
...
const listado_tabla = async (reg, res) => {
...
const insert_incidencia = async (req, res) => {
    try {
...
const actualizar_incidencia = async (req, res) => {
    try {
...
module.exports = {
    ...
    cantidad_incidencia_agrupado,
    incidencias_resueltas,
    promedio_resolucion,
    incidencia_mas_frecuente,
    area_mas_incidencia,
    listado_tabla,
    insert_incidencia,
